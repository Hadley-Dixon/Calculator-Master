"""Project 4: Calculator - core functionality
Hadley Dixon, CIS 211, 04-20-2022
"""
...
class IntConst(Expr):
    ...
    def eval(self):
        """returns the value obtained by evaluating the expression. For example, the expression"""
        return self
